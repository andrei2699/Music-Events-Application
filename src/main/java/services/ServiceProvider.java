...
public final class ServiceProvider {
    ...
    private static final IReservationService reservationService = new ReservationServiceImpl(new JSONRepository<>(ReservationModel.class, storageManager), new JSONRepository<>(EventModel.class, storageManager));
