...
public class CardsTableViewWithSearchbarControllerTest extends ApplicationTest {
    ...
    public void testSetupTableData() {
        ...
        EventCardModel eventCardModel = new EventCardModel(new EventModel(1, 4, 0, "Nume", "06-07-2020", 15, 80));
        ArtistCardModel artistCardModel = new ArtistCardModel(new ArtistModel(1, false, "Rock"));
